...
- [第12回 (2026.5.22)](#第12回-2026522-予定)　← 次回 また金曜午後に戻ります。時間はいつもと異なり15:00〜です
...
- (1) Colab&thinsp;の便利な使い方：セルにタイトルを付けると便利
  ...
  - タイトル内でHTMLタグが使える（BRで改行等）

  - Pythonの文法上は単なるコメント、処理に影響しない

<br>

- (2) 前回 4/28 の振り返り → [サマリ](day-11/day-11-summary.md)&thinsp;を参照

- (3) 参加者のうち1人の画面を共有してもらい、一緒に作業

  - 作業内容（候補）

    - 前回の続き（Chapter 5 動画関連）→ [<ins>新しい解説</ins>](./chapter-5/colab-chapter-5-readme-2.md)&thinsp;を追加したので、それにそって

    - または、静止画の処理など Chapter 5 が途中の人がいればそこから

    - または、Chapter 5 以前から再開の人がいればそこから
