...
- (1) 前回の振り返り
  ...
  - Chapter 3（本 `p.68〜`）を一通り終えた
    ...
    - Chapter 4 の準備を兼ねて作成した新しい関数 [`record_auto_stop.py`](https://github.com/ec22s/colab-ikinari-python/blob/main/chapter-3/record_auto_stop.py) を試し、マイクへの発話が終わった時に録音が自動終了期待するのを確認した
